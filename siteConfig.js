module.exports = {
  siteUrl: "https://25emarket.com", // Site domain. Do not include a trailing slash!
  ...
  shortTitle: "25emarket", // Used for App manifest e.g. Mobile Home Screen
  siteIcon: "favicon.png", // Logo in /static dir used for SEO, RSS, and App manifest
  backgroundColor: "#e9e9e9", // Used for Offline Manifest
  themeColor: "#15171A", // Used for Offline Manifest
  apiUrl: "https://reshet.jetdomains.co.il/25emarket",
  subscribeWidget: {
    visible: false,
    title: "25emarket",
  ...
  header: {
    navigation: [
      {
        label: "Homepage",
        url: "https://25emarket.com/",
      },
      {
        label: "Contact",
        url: "https://25emarket.com/contact",
      },
    ],
  },
  footer: {
    ...
    navigation: [
      ...
      {
        label: "Sitemap",
        url: "https://25emarket.com/sitemap.xml",
      },
